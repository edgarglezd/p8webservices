 ...
 * 
 */
@WebServiceClient(name = "WSGestionUsuario", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8080/WSUsuario/WSGestionUsuario?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSGESTIONUSUARIO_QNAME = new QName("http://webservice/", "WSGestionUsuario");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WSUsuario/WSGestionUsuario?wsdl");
    ...
    public WSGestionUsuario getWSGestionUsuarioPort() {
        return super.getPort(new QName("http://webservice/", "WSGestionUsuarioPort"), WSGestionUsuario.class);
    }
    ...
    public WSGestionUsuario getWSGestionUsuarioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "WSGestionUsuarioPort"), WSGestionUsuario.class, features);
    }
