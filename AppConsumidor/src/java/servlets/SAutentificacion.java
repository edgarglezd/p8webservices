...
public class SAutentificacion extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/WSUsuario/WSGestionUsuario.wsdl")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cuenta cuenta=validar(id, nombre, cvv);
        if(cuenta!=null)
        {
              HttpSession sesion = request.getSession();
              sesion.setAttribute("validaUsuario", cuenta);
...
private Cuenta validar(java.lang.String id, java.lang.String nombre, java.lang.String cvv) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        webservice.WSGestionUsuario port = service.getWSGestionUsuarioPort();
        return port.validar(id, nombre, cvv);
    }
